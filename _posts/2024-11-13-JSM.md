...
$$
\begin{split}
    p_{GGD} (\mathbf{X}) = \begin{cases} \text{Gaussian Dist}'n & \text{if} \quad \mathbf{v} = 2 \\ 
    \text{Laplacian Dist'n} & \text{if} \quad \mathbf{v} = 1 \\
    \text{hyper-Laplacian} & \text{if} \quad 0 < \mathbf{v} < 1 \\ \end{cases} \\
\end{split}
$$
...
$$
\begin{split}
    \Psi_{NLSM} (u) = \Vert \Theta_u \Vert_{1} = \sum_{i=1}^n \Vert T^{3D}(Z_{u^i}) \Vert_{1}
\end{split}
$$
...
$$
\begin{split}
    \Psi_{JSM}(u) = \tau \cdot \Psi_{LSM}(u) + \lambda \cdot \Psi_{NLSM}(u) = \tau \cdot \Vert \mathcal{D} u \Vert_{1} + \lambda \cdot \Vert \Theta_u \Vert_{1}
\end{split}
$$
...
$$
\begin{split}
    \lim_{N \rightarrow \infin, K \rightarrow \infin} \mathbb{P} \left[ \left\| \frac{1}{N} \vert x-r \vert_{2}^2 - \frac{1}{N} \vert \Theta_x - \Theta_r \vert_{2}^2 < \epsilon \right\| \right] = 1
\end{split}
$$
...
$$
\begin{split}
    &\lim_{N \rightarrow \infin} \mathbb{P} \left[ \left\| \frac{1}{N} \sum_{j=1}^N e(j)^2 - \sigma^2 \ \right\| < \frac{\epsilon}{2} \right] = 1, \\
    &\lim_{N \rightarrow \infin} \mathbb{P} \left[ \left\| \frac{1}{N} \vert x-r \vert_{2}^2 - \sigma^2 \ \right\| < \frac{\epsilon}{2} \right] = 1 \\
\end{split}
$$
...
$$
\begin{split}
    &\lim_{K \rightarrow \infin} \mathbb{P} \left[ \left\| \frac{1}{K} \sum_{j=1}^K \Theta_e(j)^2 - \sigma^2 \ \right\| < \frac{\epsilon}{2} \right] = 1, \\
    &\lim_{K \rightarrow \infin} \mathbb{P} \left[ \left\| \frac{1}{K} \vert \Theta_x - \Theta_r \vert_{2}^2 - \sigma^2 \ \right\| < \frac{\epsilon}{2} \right] = 1  \quad \Box \\
\end{split}
$$
