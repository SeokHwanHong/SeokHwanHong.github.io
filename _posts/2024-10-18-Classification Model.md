---
layout: single
title: "Classification Models in Statistics"
categories:
  - "Machine Learning"
author_profile: true
use_math: true
...
<p align="center">
  ...
  <br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <b>[ Figure 1 : Decision Tree Example ]</b>
</p>
...
$$R_1(j,s) = \{ x \vert x_j \le s \} \; : \; X_k \le s$$ 인 점들의 영역

$$R_2(j,s) = \{ x \vert x_j \ge s \} \; : \; X_k > s$$ 인 점들의 영역
...
$$Z = \{(x_1, y_1), (x_2, y_2), \dots ,(x_n, y_n)  \} $$ : 주어진 Data
...
$$S_1(x)$$ 는 $$n=B$$ 이고 $$p = 1 - \text{err}$$ 인 이항분포이고, $$B$$ 가 커지면 $$\mathbb{P} = (S_1(x) > B / 2) \rightarrow 1$$ 이다.
...
$$\mathcal{D} = \{ (x_1, y_1), (x_2, y_2), \dots ,(x_n, y_n) \}$$ : 주어진 학습 데이터
