...
<figure style="text-align: center;">
    ...
    <figcaption>[ figure1 : Training sequence of Discriminator for time steps ]</figcaption>
</figure>
...
$\mathbb{E}_{\mathbf{z} \sim p_{\mathbf{z}}({\mathbf{z}})} [1-logD(G(\mathbf{z}))]$ : $\mathbf{z}$ 에서 샘플 $z$를 뽑아 $1-logD(G(z))$의 기댓값을 계산 
...
미니배치 최적화 진행 알고리즘
<figure style="text-align: center;">
    <img src = "/images/GAN/algorithm1.jpg">
    <figcaption>[ Algorithm1 : Minibatch SGD Training ]</figcaption>
</figure>
...
<figure style="text-align: center;">
    ...
    <figcaption>[ Table1 : Parzen window-based log-likelihood estimates ]</figcaption>
</figure>
...
<figure style="text-align: center;">
    ...
    <figcaption>[ figure2 : Visualizations of samples ]</figcaption>
</figure>
