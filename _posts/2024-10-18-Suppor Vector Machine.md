...
$$
\begin{split}
    \min \; \frac{1}{2} \Vert \omega \Vert^2 \quad \text{subject to} \quad y_i(\omega \cdot x_i + b) \ge 1 \quad \forall \; i \in \mathbb{N}
\end{split}
$$
...
$$
\begin{split}
    \min \: \left[ \frac{1}{2} \Vert \omega \Vert^2 + C \sum_{i=1}^n \xi_i \quad \text{subject to} \quad y_i(\omega \cdot x_i + b) \ge 1 - \xi_i \right], \quad \xi \ge 0 \;\; \& \;\; \forall \; i \in \mathbb{N}
\end{split}
$$
